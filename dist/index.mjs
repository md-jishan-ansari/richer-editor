...
import React36, { useCallback, useState as useState4, useImperativeHandle, forwardRef } from "react";
...
import { mergeAttributes as mergeAttributes8, Node as Node7, textblockTypeInputRule } from "@tiptap/core";
...
var CustomCodeBlock = CodeBlock.extend({
  ...
  renderHTML({ node, HTMLAttributes }) {
    ...
    return [
      "pre",
      mergeAttributes9(this.options.HTMLAttributes, otherAttributes),
...
var ExpandIcon = ({ size = 24, color = "currentColor", className = "", ...props }) => /* @__PURE__ */ React30.createElement(
  "svg",
  {
    xmlns: "http://www.w3.org/2000/svg",
    width: size,
  ...
  /* @__PURE__ */ React30.createElement("path", { d: "m6 9 6 6 6-6" })
);
...
var CustomSelect = ({ value, options, onChange, className, placeholder, label, title }) => {
  ...
  return /* @__PURE__ */ React31.createElement(
    ...
    label && /* @__PURE__ */ React31.createElement("div", { className: "richer-editor-label" }, label),
    /* @__PURE__ */ React31.createElement(
      ...
      /* @__PURE__ */ React31.createElement("span", { className: selectedOption ? void 0 : "richer-editor-placeholder" }, selectedOption ? selectedOption.label : placeholder || "Select..."),
      /* @__PURE__ */ React31.createElement("span", { className: "richer-editor-chevron", "aria-hidden": true }, /* @__PURE__ */ React31.createElement(ExpandIcon_default, { size: 18 }))
    ),
...
import React33, { useState as useState3 } from "react";
var commonLanguages = [
...
var LineHeightIcon = ({ size = 24, color = "currentColor", className = "", ...props }) => /* @__PURE__ */ React34.createElement(
  "svg",
  {
    xmlns: "http://www.w3.org/2000/svg",
    width: size,
  ...
  /* @__PURE__ */ React34.createElement("path", { d: "M12 8V2" }),
  /* @__PURE__ */ React34.createElement("path", { d: "M4 12H2" }),
  /* @__PURE__ */ React34.createElement("path", { d: "M10 12H8" }),
  /* @__PURE__ */ React34.createElement("path", { d: "M16 12h-2" }),
  /* @__PURE__ */ React34.createElement("path", { d: "M22 12h-2" }),
  /* @__PURE__ */ React34.createElement("path", { d: "m15 19-3 3-3-3" }),
  /* @__PURE__ */ React34.createElement("path", { d: "m15 5-3-3-3 3" })
);
var LineHeightIcon_default = LineHeightIcon;

// src/icons/DragIcon.tsx
import React35 from "react";
var DragIcon = ({ size = 24, color = "currentColor", className = "", ...props }) => /* @__PURE__ */ React35.createElement(
  "svg",
  {
    xmlns: "http://www.w3.org/2000/svg",
    width: size,
  ...
  /* @__PURE__ */ React35.createElement("circle", { cx: "12", cy: "9", r: "1" }),
  /* @__PURE__ */ React35.createElement("circle", { cx: "19", cy: "9", r: "1" }),
  /* @__PURE__ */ React35.createElement("circle", { cx: "5", cy: "9", r: "1" }),
  /* @__PURE__ */ React35.createElement("circle", { cx: "12", cy: "15", r: "1" }),
  /* @__PURE__ */ React35.createElement("circle", { cx: "19", cy: "15", r: "1" }),
  /* @__PURE__ */ React35.createElement("circle", { cx: "5", cy: "15", r: "1" })
);
...
var MenuBar = ({ editor, imageUploadUrl, excludeToolbarButtons = [], i18n = {}, fontSizeOptions, fontFamilyOptions, customToolbarButtons }) => {
  const [editorState, setEditorState] = useState4({
  ...
  const [imageDropdownOpen, setImageDropdownOpen] = useState4(false);
  ...
  const [videoDropdownOpen, setVideoDropdownOpen] = useState4(false);
  const [videoUrl, setVideoUrl] = useState4("");
  const [videoWidth, setVideoWidth] = useState4("");
  const [videoHeight, setVideoHeight] = useState4("");
  const [linkDropdownOpen, setLinkDropdownOpen] = useState4(false);
  const [linkUrl, setLinkUrl] = useState4("");
  const [linkTarget, setLinkTarget] = useState4("_blank");
  const [textColorPopoverOpen, setTextColorPopoverOpen] = React36.useState(false);
  const textColorButtonRef = React36.useRef(null);
  const [bgColorPopoverOpen, setBgColorPopoverOpen] = React36.useState(false);
  const bgColorButtonRef = React36.useRef(null);
  ...
  return /* @__PURE__ */ React36.createElement(React36.Fragment, null, /* @__PURE__ */ React36.createElement("div", { className: "richer-editor-toolbar" }, !excludeToolbarButtons.includes("heading") && /* @__PURE__ */ React36.createElement(React36.Fragment, null, /* @__PURE__ */ React36.createElement(
  ...
  ), !excludeToolbarButtons.includes("fontFamily") && /* @__PURE__ */ React36.createElement(React36.Fragment, null, /* @__PURE__ */ React36.createElement(
    CustomSelect_default,
    {
      value: "__placeholder__",
      options: (fontFamilyOptions || fontFamilies).map((f) => ({
        value: f.value,
        label: /* @__PURE__ */ React36.createElement("span", { style: { fontFamily: f.value } }, f.name)
      })),
  ...
  ), /* @__PURE__ */ React36.createElement("div", { className: "richer-editor-toolbar-divider" })), !excludeToolbarButtons.includes("lineHeight") && /* @__PURE__ */ React36.createElement(
    CustomSelect_default,
    {
      value: "__placeholder__",
      options: [
      ...
      className: "richer-editor-select",
      placeholder: /* @__PURE__ */ React36.createElement(LineHeightIcon_default, { size: 16 }),
  ...
  ), /* @__PURE__ */ React36.createElement("div", { className: "richer-editor-toolbar-divider" })), !excludeToolbarButtons.includes("bulletList") && /* @__PURE__ */ React36.createElement(React36.Fragment, null, /* @__PURE__ */ React36.createElement("button", { onClick: () => editor.chain().focus().toggleBulletList().run(), className: `richer-editor-button ${editor.isActive("bulletList") ? "richer-editor-buttonActive" : ""}`, type: "button", "aria-label": labels.bulletList, title: labels.bulletList }, /* @__PURE__ */ React36.createElement(BulletListIcon_default, { size: 16 })), /* @__PURE__ */ React36.createElement(
    CustomSelect_default,
    {
      value: "__placeholder__",
      options: unorderedListStyles.map((opt) => ({ value: opt.value, label: /* @__PURE__ */ React36.createElement(React36.Fragment, null, opt.icon, " ", opt.name) })),
      onChange: (val) => {
  ...
  )), !excludeToolbarButtons.includes("orderedList") && /* @__PURE__ */ React36.createElement(React36.Fragment, null, /* @__PURE__ */ React36.createElement("button", { onClick: () => editor.chain().focus().toggleOrderedList().run(), className: `richer-editor-button ${editor.isActive("orderedList") ? "richer-editor-buttonActive" : ""}`, type: "button", "aria-label": labels.orderedList, title: labels.orderedList }, /* @__PURE__ */ React36.createElement(OrderedListIcon_default, { size: 16 })), /* @__PURE__ */ React36.createElement(
    CustomSelect_default,
    {
      value: "__placeholder__",
      options: orderedListStyles.map((opt) => ({ value: opt.value, label: /* @__PURE__ */ React36.createElement(React36.Fragment, null, opt.icon, " ", opt.name) })),
      onChange: (val) => {
  ...
  )), !excludeToolbarButtons.includes("taskList") && /* @__PURE__ */ React36.createElement(React36.Fragment, null, /* @__PURE__ */ React36.createElement("button", { onClick: () => editor.chain().focus().toggleTaskList().run(), className: `richer-editor-button ${editor.isActive("taskList") ? "richer-editor-buttonActive" : ""}`, type: "button", "aria-label": labels.taskList, title: labels.taskList }, /* @__PURE__ */ React36.createElement(TaskListIcon_default, { size: 16 })), /* @__PURE__ */ React36.createElement("div", { className: "richer-editor-toolbar-divider" })), !excludeToolbarButtons.includes("blockquote") && /* @__PURE__ */ React36.createElement("button", { onClick: () => editor.chain().focus().toggleBlockquote().run(), className: `richer-editor-button ${editor.isActive("blockquote") ? "richer-editor-buttonActive" : ""}`, type: "button", "aria-label": labels.blockquote, title: labels.blockquote }, /* @__PURE__ */ React36.createElement(BlockquoteIcon_default, { size: 16 })), !excludeToolbarButtons.includes("hr") && /* @__PURE__ */ React36.createElement(React36.Fragment, null, /* @__PURE__ */ React36.createElement("button", { onClick: () => editor.chain().focus().setHorizontalRule().run(), className: "richer-editor-button", type: "button", "aria-label": labels.hr, title: labels.hr }, "HR"), /* @__PURE__ */ React36.createElement("div", { className: "richer-editor-toolbar-divider" })), !excludeToolbarButtons.includes("link") && /* @__PURE__ */ React36.createElement(
    CustomDropdown_default,
    {
      ...
      trigger: /* @__PURE__ */ React36.createElement(
        "button",
        {
    ...
    /* @__PURE__ */ React36.createElement(
      ...
      /* @__PURE__ */ React36.createElement("option", { value: "_self" }, "Same Tab (_self)"),
      /* @__PURE__ */ React36.createElement("option", { value: "_parent" }, "Parent Frame (_parent)"),
      /* @__PURE__ */ React36.createElement("option", { value: "_top" }, "Top Frame (_top)")
    ),
  ...
  ), !excludeToolbarButtons.includes("image") && /* @__PURE__ */ React36.createElement(
    CustomDropdown_default,
    {
    ...
    ), uploading && /* @__PURE__ */ React36.createElement("div", { className: "richer-editor-textSm richer-editor-textBlue600 richer-editor-mb2" }, labels.uploading), uploadError && /* @__PURE__ */ React36.createElement("div", { className: "richer-editor-textSm richer-editor-textRed600 richer-editor-mb2" }, labels.uploadFailed)), uploadedImageUrl && /* @__PURE__ */ React36.createElement(React36.Fragment, null, /* @__PURE__ */ React36.createElement("div", { className: "richer-editor-mb2 richer-editor-flex richer-editor-flexCol richer-editor-itemsCenter" }, /* @__PURE__ */ React36.createElement("img", { src: uploadedImageUrl, alt: "Preview", className: "richer-editor-maxH40 richer-editor-maxWFull rounded border mb-2" })), /* @__PURE__ */ React36.createElement("div", { className: "richer-editor-flexRowMb2" }, /* @__PURE__ */ React36.createElement(
      "input",
      {
        type: "text",
        placeholder: labels.width,
  ...
  ), !excludeToolbarButtons.includes("video") && /* @__PURE__ */ React36.createElement(
    CustomDropdown_default,
    {
  ...
  ), !excludeToolbarButtons.includes("alignLeft") && /* @__PURE__ */ React36.createElement("button", { onClick: () => editor.chain().focus().setTextAlign("left").run(), className: `richer-editor-button ${editor.isActive({ textAlign: "left" }) ? "richer-editor-buttonActive" : ""}`, type: "button", "aria-label": labels.alignLeft, title: labels.alignLeft }, /* @__PURE__ */ React36.createElement(AlignLeft_default, { size: 16 })), !excludeToolbarButtons.includes("alignCenter") && /* @__PURE__ */ React36.createElement("button", { onClick: () => editor.chain().focus().setTextAlign("center").run(), className: `richer-editor-button ${editor.isActive({ textAlign: "center" }) ? "richer-editor-buttonActive" : ""}`, type: "button", "aria-label": labels.alignCenter, title: labels.alignCenter }, /* @__PURE__ */ React36.createElement(AlignCenter_default, { size: 16 })), !excludeToolbarButtons.includes("alignRight") && /* @__PURE__ */ React36.createElement("button", { onClick: () => editor.chain().focus().setTextAlign("right").run(), className: `richer-editor-button ${editor.isActive({ textAlign: "right" }) ? "richer-editor-buttonActive" : ""}`, type: "button", "aria-label": labels.alignRight, title: labels.alignRight }, /* @__PURE__ */ React36.createElement(AlignRight_default, { size: 16 })), !excludeToolbarButtons.includes("alignJustify") && /* @__PURE__ */ React36.createElement("button", { onClick: () => editor.chain().focus().setTextAlign("justify").run(), className: `richer-editor-button ${editor.isActive({ textAlign: "justify" }) ? "richer-editor-buttonActive" : ""}`, type: "button", "aria-label": labels.alignJustify, title: labels.alignJustify }, /* @__PURE__ */ React36.createElement(AlignJustify_default, { size: 16 })), !excludeToolbarButtons.includes("textColor") && /* @__PURE__ */ React36.createElement("div", { className: "richer-editor-colorpicker-wrapper" }, /* @__PURE__ */ React36.createElement("span", { style: { display: "flex", alignItems: "center" } }, /* @__PURE__ */ React36.createElement(TextColorIcon_default, { size: 16 })), /* @__PURE__ */ React36.createElement(
    CustomDropdown_default,
    {
      ...
      trigger: /* @__PURE__ */ React36.createElement(
        ...
        /* @__PURE__ */ React36.createElement("span", { style: {
    ...
    /* @__PURE__ */ React36.createElement("div", { style: { minWidth: 200, padding: 16 } }, editor.getAttributes("textStyle").color && /* @__PURE__ */ React36.createElement(
      "button",
      {
      ...
      labels.removeColor
    ), /* @__PURE__ */ React36.createElement("div", { style: { display: "grid", gridTemplateColumns: "repeat(6, 1fr)", gap: 8, marginBottom: 12 } }, colorPalette.map((color) => /* @__PURE__ */ React36.createElement(
      "button",
      {
        key: color,
        type: "button",
  ...
  )), !excludeToolbarButtons.includes("bgColor") && /* @__PURE__ */ React36.createElement("div", { className: "richer-editor-colorpicker-wrapper" }, /* @__PURE__ */ React36.createElement("span", { style: { display: "flex", alignItems: "center" } }, /* @__PURE__ */ React36.createElement(PaintBucket_default, { size: 16 })), /* @__PURE__ */ React36.createElement(
    CustomDropdown_default,
    {
    ...
    /* @__PURE__ */ React36.createElement("div", { style: { minWidth: 200, padding: 16 } }, editor.getAttributes("highlight").color && /* @__PURE__ */ React36.createElement(
      "button",
      {
        className: "richer-editor-secondaryBtn mb-2 w-full",
        onClick: () => {
  ...
  )), !excludeToolbarButtons.includes("subscript") && /* @__PURE__ */ React36.createElement(
    "button",
    {
    ...
    /* @__PURE__ */ React36.createElement(SubscriptIcon_default, { size: 16 })
  ), !excludeToolbarButtons.includes("superscript") && /* @__PURE__ */ React36.createElement(
    "button",
    {
    ...
    /* @__PURE__ */ React36.createElement(SuperscriptIcon_default, { size: 16 })
  ), customToolbarButtons && (typeof customToolbarButtons === "function" ? customToolbarButtons(editor) : customToolbarButtons), !excludeToolbarButtons.includes("undo") && /* @__PURE__ */ React36.createElement(React36.Fragment, null, /* @__PURE__ */ React36.createElement("div", { className: "richer-editor-toolbar-divider" }), /* @__PURE__ */ React36.createElement("button", { onClick: () => editor.chain().focus().undo().run(), className: "richer-editor-button", type: "button", "aria-label": labels.undo, title: labels.undo }, /* @__PURE__ */ React36.createElement(UndoIcon_default, { size: 16 }))), !excludeToolbarButtons.includes("redo") && /* @__PURE__ */ React36.createElement("button", { onClick: () => editor.chain().focus().redo().run(), className: "richer-editor-button", type: "button", "aria-label": labels.redo, title: labels.redo }, /* @__PURE__ */ React36.createElement(RedoIcon_default, { size: 16 }))), !excludeToolbarButtons.includes("dragHandle") && /* @__PURE__ */ React36.createElement(DragHandle, { editor }, /* @__PURE__ */ React36.createElement(DragIcon_default, { size: 18, style: { marginTop: 3 } })));
};
var colorPalette = [
  "#000000",
  "#434343",
...
var RicherEditor = forwardRef(function RicherEditor2({
  ...
  return /* @__PURE__ */ React36.createElement("div", { className: `richer-editor-roundedMdBorder` }, /* @__PURE__ */ React36.createElement(MenuBar, { editor, imageUploadUrl, excludeToolbarButtons, i18n, fontSizeOptions, fontFamilyOptions, customToolbarButtons }), /* @__PURE__ */ React36.createElement("div", { className: "richer-editor-overflowAuto", style: { maxHeight } }, /* @__PURE__ */ React36.createElement(EditorContent, { editor, onBlur: handleBlur })));
});
var RicherEditor_default = RicherEditor;

// src/components/SmallRicherEditor.tsx
import React38, { useCallback as useCallback2, useImperativeHandle as useImperativeHandle2, forwardRef as forwardRef2, useState as useState5 } from "react";
...
var Heading = ({ size = 24, color = "currentColor", className = "", ...props }) => /* @__PURE__ */ React37.createElement(
  "svg",
  {
    xmlns: "http://www.w3.org/2000/svg",
    width: size,
  ...
  /* @__PURE__ */ React37.createElement("path", { d: "M6 12h12" }),
  /* @__PURE__ */ React37.createElement("path", { d: "M6 20V4" }),
  /* @__PURE__ */ React37.createElement("path", { d: "M18 20V4" })
);
...
var alignmentOptions = [
  { value: "left", label: /* @__PURE__ */ React38.createElement(AlignLeft_default, { size: 18 }), name: "Left" },
  { value: "center", label: /* @__PURE__ */ React38.createElement(AlignCenter_default, { size: 18 }), name: "Center" },
  { value: "right", label: /* @__PURE__ */ React38.createElement(AlignRight_default, { size: 18 }), name: "Right" },
  { value: "justify", label: /* @__PURE__ */ React38.createElement(AlignJustify_default, { size: 18 }), name: "Justify" }
];
var headingOptions2 = [
  { level: 1, label: /* @__PURE__ */ React38.createElement(Heading1_default, { size: 18 }) },
  { level: 2, label: /* @__PURE__ */ React38.createElement(Heading2_default, { size: 18 }) },
  { level: 3, label: /* @__PURE__ */ React38.createElement(Heading3_default, { size: 18 }) },
  { level: 4, label: /* @__PURE__ */ React38.createElement(Heading4_default, { size: 18 }) },
  { level: 5, label: /* @__PURE__ */ React38.createElement(Heading5_default, { size: 18 }) },
  { level: 6, label: /* @__PURE__ */ React38.createElement(Heading6_default, { size: 18 }) }
];
var defaultI18n2 = {
  bold: "Bold",
  italic: "Italic",
...
var MenuBar2 = ({ editor, imageUploadUrl, excludeToolbarButtons = [], i18n = {}, fontSizeOptions, fontFamilyOptions, customToolbarButtons }) => {
  const [editorState, setEditorState] = useState5({
    isCodeBlockActive: false,
    codeBlockLanguage: null
  });
  React38.useEffect(() => {
  ...
  const [imageDropdownOpen, setImageDropdownOpen] = useState5(false);
  const [imageTab, setImageTab] = useState5("url");
  const [imageUrl, setImageUrl] = useState5("");
  const [imageWidth, setImageWidth] = useState5("");
  const [imageHeight, setImageHeight] = useState5("");
  const [uploading, setUploading] = useState5(false);
  const [uploadError, setUploadError] = useState5(null);
  const [uploadedImageUrl, setUploadedImageUrl] = useState5("");
  const [imageFile, setImageFile] = useState5(null);
  const [videoDropdownOpen, setVideoDropdownOpen] = useState5(false);
  const [videoUrl, setVideoUrl] = useState5("");
  const [videoWidth, setVideoWidth] = useState5("");
  const [videoHeight, setVideoHeight] = useState5("");
  const [linkDropdownOpen, setLinkDropdownOpen] = useState5(false);
  const [linkUrl, setLinkUrl] = useState5("");
  const [linkTarget, setLinkTarget] = useState5("_blank");
  const linkButtonRef = React38.useRef(null);
  const imageButtonRef = React38.useRef(null);
  const videoButtonRef = React38.useRef(null);
  ...
  if (!editor) return null;
  return /* @__PURE__ */ React38.createElement(React38.Fragment, null, /* @__PURE__ */ React38.createElement("div", { className: "richer-editor-toolbar" }, !excludeToolbarButtons.includes("heading") && /* @__PURE__ */ React38.createElement(React38.Fragment, null, /* @__PURE__ */ React38.createElement(
    CustomSelect_default,
    {
      value: "__placeholder__",
      options: [
      ...
      className: "richer-editor-select",
      placeholder: /* @__PURE__ */ React38.createElement(Heading_default, { size: 16 }),
      "aria-label": "Heading Level"
    }
  ), /* @__PURE__ */ React38.createElement("div", { className: "richer-editor-toolbar-divider" })), !excludeToolbarButtons.includes("fontSize") && /* @__PURE__ */ React38.createElement(
    CustomSelect_default,
    {
      value: "__placeholder__",
  ...
  ), /* @__PURE__ */ React38.createElement("div", { className: "richer-editor-toolbar-divider" })), !excludeToolbarButtons.includes("bulletList") && /* @__PURE__ */ React38.createElement("button", { onClick: () => editor.chain().focus().toggleBulletList().run(), className: `richer-editor-button${editor.isActive("bulletList") ? " richer-editor-buttonActive" : ""}`, type: "button", "aria-label": labels.bulletList, title: labels.bulletList }, /* @__PURE__ */ React38.createElement(BulletListIcon_default, { size: 16 })), !excludeToolbarButtons.includes("orderedList") && /* @__PURE__ */ React38.createElement(React38.Fragment, null, /* @__PURE__ */ React38.createElement("button", { onClick: () => editor.chain().focus().toggleOrderedList().run(), className: `richer-editor-button${editor.isActive("orderedList") ? " richer-editor-buttonActive" : ""}`, type: "button", "aria-label": labels.orderedList, title: labels.orderedList }, /* @__PURE__ */ React38.createElement(OrderedListIcon_default, { size: 16 })), /* @__PURE__ */ React38.createElement("div", { className: "richer-editor-toolbar-divider" })), !excludeToolbarButtons.includes("blockquote") && /* @__PURE__ */ React38.createElement("button", { onClick: () => editor.chain().focus().toggleBlockquote().run(), className: `richer-editor-button ${editor.isActive("blockquote") ? "richer-editor-buttonActive" : ""}`, type: "button", "aria-label": labels.blockquote, title: labels.blockquote }, /* @__PURE__ */ React38.createElement(BlockquoteIcon_default, { size: 16 })), !excludeToolbarButtons.includes("hr") && /* @__PURE__ */ React38.createElement(React38.Fragment, null, /* @__PURE__ */ React38.createElement("button", { onClick: () => editor.chain().focus().setHorizontalRule().run(), className: "richer-editor-button", type: "button", "aria-label": labels.hr, title: labels.hr }, "HR"), /* @__PURE__ */ React38.createElement("div", { className: "richer-editor-toolbar-divider" })), !excludeToolbarButtons.includes("link") && /* @__PURE__ */ React38.createElement(
    CustomDropdown_default,
    {
      open: linkDropdownOpen,
      onOpenChange: (open) => {
      ...
      trigger: /* @__PURE__ */ React38.createElement(
        ...
        /* @__PURE__ */ React38.createElement(LinkIcon_default, { size: 16 })
      ),
      width: "280px"
    },
    /* @__PURE__ */ React38.createElement("div", { className: "richer-editor-mb2 richer-editor-fontSemibold richer-editor-textBase" }, labels.link),
    ...
    /* @__PURE__ */ React38.createElement(
      ...
      /* @__PURE__ */ React38.createElement("option", { value: "_blank" }, labels.newTab),
      /* @__PURE__ */ React38.createElement("option", { value: "_self" }, labels.sameTab),
      /* @__PURE__ */ React38.createElement("option", { value: "_parent" }, labels.parentFrame),
      /* @__PURE__ */ React38.createElement("option", { value: "_top" }, labels.topFrame)
    ),
    /* @__PURE__ */ React38.createElement("div", { className: "richer-editor-flexRow" }, /* @__PURE__ */ React38.createElement(
      "button",
      {
        className: "richer-editor-primaryBtn",
        onClick: handleLinkInsert,
  ...
  ), !excludeToolbarButtons.includes("image") && /* @__PURE__ */ React38.createElement(
    CustomDropdown_default,
    {
      open: imageDropdownOpen,
      onOpenChange: (open) => {
      ...
      trigger: /* @__PURE__ */ React38.createElement(
        ...
        /* @__PURE__ */ React38.createElement(ImageIcon_default, { size: 16 })
      ),
      width: "320px"
    },
    /* @__PURE__ */ React38.createElement("div", { className: "richer-editor-mb2 richer-editor-fontSemibold richer-editor-textBase flex gap-4 border-b pb-2" }, /* @__PURE__ */ React38.createElement("button", { className: `richer-editor-button${imageTab === "url" ? " richer-editor-buttonActive" : ""}`, onClick: () => setImageTab("url") }, labels.url), imageUploadUrl && /* @__PURE__ */ React38.createElement("button", { className: `richer-editor-button${imageTab === "upload" ? " richer-editor-buttonActive" : ""}`, onClick: () => setImageTab("upload") }, labels.upload)),
    imageTab === "url" && /* @__PURE__ */ React38.createElement(React38.Fragment, null, /* @__PURE__ */ React38.createElement(
      "input",
      {
        type: "text",
        placeholder: labels.pasteImageUrl,
    ...
    ), /* @__PURE__ */ React38.createElement("div", { className: "richer-editor-flexRowMb2" }, /* @__PURE__ */ React38.createElement(
      "input",
      {
        type: "text",
        placeholder: labels.width,
    ...
    )), /* @__PURE__ */ React38.createElement("div", { className: "richer-editor-textXs" }, "Leave blank for default size. Use px (e.g. 400) or % (e.g. 50%)."), /* @__PURE__ */ React38.createElement(
      "button",
      {
        className: "richer-editor-primaryBtn",
        onClick: handleImageUrlInsert,
    ...
    imageTab === "upload" && imageUploadUrl && /* @__PURE__ */ React38.createElement(React38.Fragment, null, !uploadedImageUrl && /* @__PURE__ */ React38.createElement(React38.Fragment, null, /* @__PURE__ */ React38.createElement(
      "input",
      {
        type: "file",
        accept: "image/*",
    ...
    ), uploading && /* @__PURE__ */ React38.createElement("div", { className: "richer-editor-textSm richer-editor-textBlue600 richer-editor-mb2" }, labels.uploading), uploadError && /* @__PURE__ */ React38.createElement("div", { className: "richer-editor-textSm richer-editor-textRed600 richer-editor-mb2" }, labels.uploadFailed)), uploadedImageUrl && /* @__PURE__ */ React38.createElement(React38.Fragment, null, /* @__PURE__ */ React38.createElement("div", { className: "richer-editor-mb2 flex flex-col items-center" }, /* @__PURE__ */ React38.createElement("img", { src: uploadedImageUrl, alt: "Preview", className: "richer-editor-maxH40 richer-editor-maxWFull rounded border mb-2" })), /* @__PURE__ */ React38.createElement("div", { className: "richer-editor-flexRowMb2" }, /* @__PURE__ */ React38.createElement(
      "input",
      {
        type: "text",
        placeholder: labels.width,
  ...
  ), !excludeToolbarButtons.includes("video") && /* @__PURE__ */ React38.createElement(
    CustomDropdown_default,
    {
      open: videoDropdownOpen,
      onOpenChange: (open) => setVideoDropdownOpen(open),
      trigger: /* @__PURE__ */ React38.createElement(
        ...
        /* @__PURE__ */ React38.createElement(VideoIcon_default, { size: 16 })
      ),
      width: "280px"
    },
    /* @__PURE__ */ React38.createElement("div", { className: "richer-editor-mb2 richer-editor-fontSemibold richer-editor-textBase" }, labels.video),
    /* @__PURE__ */ React38.createElement(
      "input",
      {
        type: "text",
    ...
    /* @__PURE__ */ React38.createElement("div", { className: "richer-editor-textXs" }, "Leave blank for default size. Use px (e.g. 400) or % (e.g. 50%)."),
    /* @__PURE__ */ React38.createElement(
      "button",
      {
        className: "richer-editor-primaryBtn",
  ...
  ), !excludeToolbarButtons.includes("align") && /* @__PURE__ */ React38.createElement(
    CustomSelect_default,
    {
      value: "__placeholder__",
      options: alignmentOptions.map((opt) => ({ value: opt.value, label: /* @__PURE__ */ React38.createElement(React38.Fragment, null, opt.label, " ", opt.name) })),
      onChange: (val) => editor.chain().focus().setTextAlign(val).run(),
      className: "richer-editor-select",
      placeholder: /* @__PURE__ */ React38.createElement(AlignJustify_default, { size: 16 })
    }
...
var SmallRicherEditor = forwardRef2(function SmallRicherEditor2({
  ...
  return /* @__PURE__ */ React38.createElement("div", { className: `richer-editor-roundedMdBorder` }, /* @__PURE__ */ React38.createElement(MenuBar2, { editor, imageUploadUrl, excludeToolbarButtons, i18n, fontSizeOptions, fontFamilyOptions, customToolbarButtons }), /* @__PURE__ */ React38.createElement("div", { className: "richer-editor-overflowAuto", style: { maxHeight } }, /* @__PURE__ */ React38.createElement(EditorContent2, { editor, onBlur: handleBlur })));
});
...
var RicherContent = ({ content, className = "" }) => {
  return /* @__PURE__ */ React39.createElement("div", { className }, /* @__PURE__ */ React39.createElement(
    "div",
    {
